  ...
  // ABI details for the smart contract methods
...
// Function to generate image URLs based on the image number
...
document.addEventListener("DOMContentLoaded", async () => {
  // Get the container element to render minted NFTs
  const appContainer = document.getElementById("mint");

  // Loop to create NFT containers and buttons
  for (let index = 0; index < 4; index++) {
    const nftContainer = document.createElement("div");
    nftContainer.className = "App-main";

    // Create an image element for the NFT
    const nftImage = document.createElement("img");
    nftImage.src = generateS3ImageUrl(index + 5); // Generating URLs from image number
    nftImage.alt = "NFT";
    nftImage.width = 100;
    ...
    mintButton.textContent = "Buy NFT";
    ...
    mintButton.addEventListener("click", async () => {
      ...
      try {
        ...
        // Mint the NFT by calling the mintNFT method
    ...
    // Append the image and button to the NFT container
